document.addEventListener('DOMContentLoaded', function() {
  ...
  const fadeElements = document.querySelectorAll('.fade-in, [data-animate="fade-in"]');
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "gaygamesbbcfart uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var response = await fetch(apiBase + '/api/email/contact-form', {
                ...
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    websiteId: 'c0d5a9e0-54fe-4d82-b511-e288e9583183',
                    name: data.name || '',
                    email: data.email || '',
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c0d5a9e0-54fe-4d82-b511-e288e9583183';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c0d5a9e0-54fe-4d82-b511-e288e9583183';
